...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td>' . $row['quantity'] .str_repeat(' ', 5) . $row['product_name'] .str_repeat(' ', 5)  .'@'.str_repeat(' ', 5) .'Rs'. $row['amount']/$row['quantity'] .'</td>';
        echo '<td>' . $row['id'] . '</td>';
...
?>
<tr>
    <td colspan="4" id="bigg" >Total Sales Amount of CWIMS as on <a id="current_date"></a></td>
 <?php
