...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar">
      ...
      <div class="namecont">
      <h1 id="name1"> <?php echo $res_Uname?>-Admin</h1> 
      <div class="img__wrap">
    ...
    document.write("<h2 id='nameP'>" + title + "</h2>");
        ...
        <div class="mainmid">
        <h2 id='nameW'>Welcome to the Administrator's Panel</h2>
        <div class="centbox">
            <h2 id='nameW'>Welcome, <?php echo $res_Uname?>!</h2>
        </div>
        </div>
       </div>
       <div class="details">
        <div class="box" > <h2 id="boxedinf">Incoming Goods <br> <a href="" id="bottom">view</a></h2><i class="fa fa-box" id="infor"></i></div>
        <div class="box" > <h2 id="boxedinf">Outgoing Goods <br> <a href="" id="bottom">view</a></h2><i class="fa fa-box" id="infor"></i></div>
        <div class="box" ><h2 id="boxedinf">Suppliers <br> <a href="" id="bottom">view</a></h2><i class="fa fa-boxes" id="infor"></i></div>
        <div class="box" ><h2 id="boxedinf">Costomers <br> <a href="" id="bottom">view</a></h2><i class="fa fa-users" id="infor"></i></div>
       </div>
