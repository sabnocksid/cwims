...
<table id="myTable">
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td><a href="update.supplier.php?id='. $row['supplier_id'] . '" id="pencil"><i class="fa fa-pencil"></i></a><a href="delete.supplier.php?id=' . $row['supplier_id'] . '"><i class="fa fa-trash" id="trash"></i></a></td>';
            echo '</tr>';
        }
